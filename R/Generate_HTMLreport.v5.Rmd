...
```
#<img src="/data/wuz6/project/02.DKFZ.classifier/07.queryNeighbors/R/image/nci-logo-full.svg" alt="logo" style="height:50px;position:absolute; top:40px; left:10px; padding:10px;"/>
<img src="https://en.wikipedia.org/wiki/National_Cancer_Institute#/media/File:NCI_Stacked_COLOR.png" alt="logo" style="height:50px;position:absolute; top:40px; left:10px; padding:10px;"/>
...
![](/data/wuz6/project/02.DKFZ.classifier/07.queryNeighbors/R/image/nci-logo-full.svg){width=50%}
